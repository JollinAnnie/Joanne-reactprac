    ...
    <div className="relative">
      <div
        className={`hidden md:block h-[140px] border-b 
          ...
          ${isLast ? "w-40 mr-auto" : ""} border-yellow-500 border-dashed`}
      />

      {!isLast && (
        <div className="hidden md:block min-w-96 h-[140px] border-r border-b border-yellow-600 border-dashed" />
      )}

      <div className="bg-gradient-to-br from-yellow-950 to-slate-900 rounded-lg border border-yellow-800/40 p-4 mx-0 md:mx-10 md:absolute top-[70px] mb-6 md:mb-0">
        <div className="flex items-center justify-between flex-1">
          ...
          <div className="text-sky-200 text-[11px] md:text-xs font-medium bg-yellow-950 rounded border border-white-700/50 border-dashed justify-center items-center px-4 py-2">
            {duration}
          </div>
        </div>
